        ...
        while (!isDone)
        {
            ...
            switch (selectedMenu)
            {
                ...
                case 1:
                    ...
                    street = GetData.getString("Enter the company address: ");
                    city = GetData.getString("Enter city where the company is located: ");
                    state = GetData.getString("Enter state where the company is located: ");
                    zip = GetData.getString("Enter ZIP code where the company is located: ");

                    dateManu = GetData.getString(
                            "Enter date the product was manufacured in the form of(MM/dd/yyyy): ");
                    ...
                    else
                    {
                        ...
                        switch (subMenu)
                        {
                            ...
                            case 2:
                                ...
                                {
                                    JOptionPane.showMessageDialog(null,
                                            "Price of the product was not updated.");
                                }
                                else
                                {
                                    // get the product from the database
                                    ...
                                    JOptionPane.showMessageDialog(null,
                                            "Price of the product was updated successfully.");
                                }
                                break;
                            default:
                                JOptionPane.showMessageDialog(null,
